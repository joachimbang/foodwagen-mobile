...
//
// Objectif :
// - Centraliser les couleurs / spacing / radius.
// - Éviter les valeurs "magiques" répétées partout.
// - Garder une cohérence UI entre les écrans.
class AppStyle {
  // COLOR
  ...
  ThemeData darkTheme(BuildContext context) {
    // Thème sombre (si tu veux l'activer dans MaterialApp).
    return ThemeData(
      ...
      bottomSheetTheme: BottomSheetThemeData(backgroundColor: GRAY_100),
      textTheme: TextTheme(
        displayLarge: TextStyle(color: GRAY_900, height: 1.5, fontSize: 24),
        displayMedium: TextStyle(color: GRAY_900, height: 1.5, fontSize: 20),
        displaySmall: TextStyle(color: GRAY_900, height: 1.5, fontSize: 18),
        bodyLarge: TextStyle(color: GRAY_900, height: 1.5, fontSize: 16),
        bodyMedium: TextStyle(color: GRAY_900, height: 1.5, fontSize: 14),
        bodySmall: TextStyle(fontSize: 14, color: GRAY_600, height: 1.5),
      ),
      cardColor: GRAY_50,
      useMaterial3: true,
  ...
  ThemeData lightTheme(BuildContext context) {
    // Thème clair (si tu veux l'activer dans MaterialApp).
    return ThemeData(
      ...
      textTheme: TextTheme(
        displayLarge: TextStyle(color: GRAY_50, height: 1.5, fontSize: 24),
        displayMedium: TextStyle(color: GRAY_50, height: 1.5, fontSize: 20),
        displaySmall: TextStyle(color: GRAY_50, height: 1.5, fontSize: 18),
        bodyLarge: TextStyle(color: GRAY_50, height: 1.5, fontSize: 16),
        bodyMedium: TextStyle(color: GRAY_50, height: 1.5, fontSize: 14),
        bodySmall: TextStyle(fontSize: 14, color: GRAY_500, height: 1.5),
      ),
      fontFamily: "montserrat",
      useMaterial3: true,
